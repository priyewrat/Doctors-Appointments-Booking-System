  ...
  return (
    profileData && (
      <div className="flex flex-col gap-4 m-5">
        ...
        <div className="mt-4 border border-zinc-200 rounded-xl overflow-hidden bg-white shadow-sm w-full">
          <div className="bg-zinc-50 px-6 py-4 border-b border-zinc-200 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-gray-800 text-base md:text-lg">Manage Working Hours</h3>
            </div>
            <p className="hidden sm:flex text-sm text-gray-500 items-center gap-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    min="5"
                    step="5"
                    className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                ...
                <div className="flex flex-col justify-end">
                  <button
                    ...
                    className="w-full px-6 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-opacity-90 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all shadow-sm active:scale-95 h-[38px]"
                    disabled={
            ...
            <div className="space-y-6">
              ...
              {availabilities.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 bg-gray-50/50 rounded-xl border border-dashed border-zinc-200">
                  <FiClock className="text-zinc-300 text-5xl mb-4" />
                  <p className="text-gray-500 font-semibold">No working hours scheduled</p>
                  <p className="text-gray-400 text-sm">Add your availability above to start receiving bookings.</p>
                </div>
              )}
            </div>
          </div>
