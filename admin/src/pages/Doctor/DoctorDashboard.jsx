        ...
        <div className="bg-white">
          ...
          <div className="pt-4 border border-zinc-200 border-t-0">
            {dashData.latestAppointments.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 bg-gray-50/30">
                <img className="w-12 opacity-20 mb-2" src={assets.list_icon} alt="" />
                <p className="text-gray-400 text-sm font-medium">No recent bookings</p>
              </div>
            )}
          </div>
        </div>
